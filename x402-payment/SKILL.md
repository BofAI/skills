...
2. Require x402 CLI 1.0.1-beta.7 or newer (built with x402 SDK 1.0.1 and Gateway 1.0.1-beta.6). If it is missing, ask the user to install it with `npm install -g @bankofai/x402-cli@beta`.
