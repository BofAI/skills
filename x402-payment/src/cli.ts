...
function printHelp(): void {
  process.stdout.write(
    [
      ...
      "  x402 invoke <url> [-X <method>] [-d <json>] [-q <params>] [-h <json>]",
      "              [--entrypoint <name>] [--network <network>] [--asset <asset>]",
      "              [--pair <pair>] [--max-amount <atomic-units>]",
      "",
      "Notes:",
      "  - `pay` and `invoke` share the same x402 payment flow.",
